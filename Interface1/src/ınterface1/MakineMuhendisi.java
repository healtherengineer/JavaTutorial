...
public class MakineMuhendisi extends Muhendis implements IMuhendis,ICalis
{

    private boolean askerlik;
    private boolean adli_sicil;

    public MakineMuhendisi(String ad, String soyad,boolean askerlik, boolean adli_sicil)
    {
        super(ad,soyad);
    ...
    public void is_tecrubesi(String[] arr)
    {
        if (arr.length > 0)
        {
            System.out.println("Makine Mühendisi olarak calistigim Kurumlar : ");
    ...
    public void referans_getir(String[] arr)
    {
        if(arr.length> 0 )
        {
    ...
    public void calis()
    {
        System.out.println("Makine muhendisi olarak Şu anda Çalışıyorum...");
    }
