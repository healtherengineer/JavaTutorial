...
public class MenuKullanimi extends javax.swing.JFrame
{
    ...
    {//GEN-HEADEREND:event_jMenuItem2ActionPerformed
        ...
        JFileChooser fc = new JFileChooser(); // filecHosser dosya seçici kullanıyorum
       int i = fc.showOpenDialog(this); // open dialog açıyorum dosyalar görünsün diye eğer ok a basarsak
       if(i == JFileChooser.APPROVE_OPTION){ // Approve _option kabul değeri dönüyor
           
           File file = fc.getSelectedFile(); // seçili olan dosyayı file nesnesine atıyorum
           
        
        //   try(Scanner scanner = new Scanner(BufferedReader(new FileReader(file
          
           try(Scanner scanner = new Scanner(new BufferedReader(new FileReader(file)))){ // buffered reader ile satır satır okuyorum
                  String icerik = "";
